...
class Server extends \Test\TestCase {
	...
	public function testGetAppFolder() {
		$this->assertInstanceOf('\OCP\Files\Folder', $this->server->getAppFolder(), 'service returned by "getAppFolder" did not return the right class');
	}
